    ...
    return (
        <div className='flex justify-center items-center'>
            <div className="relative bg-base-100 w-[94%] max-w-lg shrink-0 shadow-2xl rounded-lg m-12 py-6">
                <h1 className='font-semibold text-2xl text-[#c89ea2] mx-auto mt-6 text-center'>Login your account</h1>
                ...
                <form onSubmit={handleSubmit} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <button className="py-2 px-4 bg-[#c89ea2] text-white rounded-md hover:bg-[#c89ea2]/80 hover:rounded-2xl">Login</button>
                    </div>
                ...
                <button onClick={handleGoogle} className="p-2 w-[87%] mx-8  bg-[#c89ea2] rounded-md text-white hover:bg-[#c89ea2]/80 hover:rounded-2xl">Login With Google</button>
                <p className='text-center my-4'>Don't have an account? <Link to='/auth/register' className='hover:text-[#c89ea2] link'>Register</Link> now</p>
            </div>
        </div>
    );
};
