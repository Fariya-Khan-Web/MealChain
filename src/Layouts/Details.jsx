        ...
        <div className='min-h-[calc(100vh-250px)] flex items-center'>
            <div className="my-10 w-[94%] max-w-5xl mx-auto shadow-xl">
                ...
                <div className="p-5">
                    ...
                    {/* modal opens */}
                    <div className="mt-4">
                        {/* <button onClick={()=>handleRequest(_id)} className="p-2 bg-[#f5b041] w-full text-white rounded-md hover:bg-[#f5b041]/80 hover:rounded-2xl">Request</button> */}
                        <button className="btn p-2 bg-[#f5b041] w-full text-white rounded-md hover:bg-[#f5b041]/80 hover:rounded-2xl" onClick={() => document.getElementById('my_modal_1').showModal()}>Request Food</button>
