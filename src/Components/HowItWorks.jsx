...
const HowItWorks = () => {
    return (
        <div className='max-w-screen-2xl w-[95%] mx-auto py-14'>
            <h1 className='text-5xl font-bold'>Build a community, <span className='text-[#f5b041]'>follow simple steps</span></h1>
            ...
            <div className='max-w-screen-xl mx-auto grid gap-4 md:grid-cols-2 lg:grid-cols-4 py-9'>
                ...
                <div className='bg-white rounded-md shadow-lg p-3 text-center'>
                    <div>
                        <MdOutlineAccountBox className='text-[#f5b041] text-6xl mx-auto' />
                    </div>
                ...
                <div className='bg-white rounded-md shadow-lg p-3 text-center'>
                    <div>
                        <BiDonateHeart className='text-[#f5b041] text-6xl mx-auto' />
                    </div>
                ...
                <div className='bg-white rounded-md shadow-lg p-3 text-center'>
                    <div>
                        <VscGitPullRequestClosed  className='text-[#f5b041] text-6xl mx-auto' />
                    </div>
                ...
                <div className='bg-white rounded-md shadow-lg p-3 text-center'>
                    <div>
                        <RiUserCommunityLine className='text-[#f5b041] text-6xl mx-auto' />
                    </div>
