                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-30 py-48 h-full w-full'>
                            <h1 className="text-5xl md:text-6xl lg:text-7xl  font-bold -ml-2">Meal<span className='text-[#E9B570]'>Chain</span></h1>
                            ...
                            <button className='p-2 px-3 text-lg bg-[#E9B570] rounded-md hover:bg-[#E9B57C]/95 hover:rounded-2xl mb-10'>Get Started</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-30 py-44 pt-52 h-full w-full'>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold -ml-2"><span className='text-[#E9B570]'>Share a Meal</span>, Spread the Love!</h1>
                            ...
                            <button className='p-2 px-3 text-lg bg-[#E9B570] rounded-md hover:bg-[#E9B57C]/70 hover:rounded-2xl mb-10'>Get Started</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className=''>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-40 py-44 pt-52 h-full w-full'>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold -ml-2">Transform Surplus into <span className='text-[#E9B570]'>Smiles</span></h1>
