                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-20 py-48 pt-64 h-full w-full'>
                            <h1 className="text-5xl md:text-6xl lg:text-7xl  font-bold -ml-2">Meal<span className='text-[#c89ea2]'>Chain</span></h1>
                            ...
                            <button className='p-2 px-3 text-lg bg-[#c89ea2] rounded-md hover:bg-[#c89ea2]/95 hover:rounded-2xl mb-10'>Get Started</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-20 py-44 pt-64 h-full w-full'>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold -ml-2"><span className='text-[#c89ea2]'>Share a Meal</span>, Spread the Love!</h1>
                            ...
                            <button className='p-2 px-3 text-lg bg-[#c89ea2] rounded-md hover:bg-[#c89ea2]/70 hover:rounded-2xl mb-10'>Get Started</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className=''>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-20 py-44 pt-64 h-full w-full'>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold -ml-2">Transform Surplus into <span className='text-[#c89ea2]'>Smiles</span></h1>
