                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 z-10  bg-black bg-opacity-20 dark:bg-opacity-40  md:py-48 md:pt-64  py-8 h-full w-full'>
                            ...
                            <button className='p-1 md:p-2 px-3 text-lg bg-[#d3b6b9] dark:bg-[#b88287] rounded-md hover:bg-[#d3b6b9] dark:bg-[#b88287]/95 hover:rounded-2xl mb-10'>Get Started</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
